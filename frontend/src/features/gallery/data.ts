...
export const galleryData: GalleryData = {
  ...
  name: '갤러리1',
  content:
    '이 갤러리는 19세기 영국에서 시작되어 지구를 3바퀴 돌아 이곳에 오게 되었습니다.\n 이른바 행운의 갤러리로 여겨지는 이 갤러리는 보면 기분이 좋아집니다. 그리고 왠지 느낌적인 느낌 느낌 마이 루키 마 수퍼루키루키 루키 마치마치 그 느낌적인 느낌느낌. 좀더 길게 쓰고 싶은데 더 쓸말이 없음',
