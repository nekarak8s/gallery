package com.nekarak8s.member.base.exception;
...
public class CustomExceptionHandler {
    ...
    public ResponseEntity<Object> handleMissingRequestHeader(MissingRequestHeaderException ex, HttpServletRequest request) {
        Map<String, String> map = new HashMap<>();
        map.put("errorType", HttpStatus.BAD_REQUEST.getReasonPhrase());
        map.put("errorCode", "GA005");
        map.put("message", ex.getHeaderName() + " 헤더를 확인해주세요");
