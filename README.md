...
현재는 Kubernetes를 도입하여 서비스 배포를 준비하고 있습니다. EKS 운영 부담을 줄이기 위해 AWS Lightsail 인스턴스에 k3s(Lightweight K8s)를 직접 설치하여 서비스를 준비하고 있습니다. CI/CD 전략으로는 각각 Github Actions와 Argo CD를 채택했습니다.
